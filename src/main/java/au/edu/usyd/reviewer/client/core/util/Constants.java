...
public class Constants {
	...
	/** Exception constants **/
	public static String EXCEPTION_DELETE_MESSAGE="could not be deleted";
	...
	public static String EXCEPTION_SAVE_COURSE_MESSAGE="The course could not be saved";
	...
	public static String EXCEPTION_COURSES_NO_LOADED = "The courseS could not be loaded";
	...
	public static String EXCEPTION_PERMISSION_DENIED ="Permission denied. You don't have permission to access this page.";
	...
	public static String EXCEPTION_ENCRYPT="There was a problem encrypting a value";
	public static String EXCEPTION_DECRYPT="There was a problem decrypting a value";
	...
	public static String EXCEPTION_GET_COURSES_MESSAGE="There was an error obtaining the courses";
