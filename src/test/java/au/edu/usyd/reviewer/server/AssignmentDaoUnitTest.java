...
public class AssignmentDaoUnitTest {
	...
	public void shouldLoadCourse() {
		Course course1 = assignmentDao.loadCourse(this.course1.getId());
		assertThat(course1.getLecturers().size(), is(1));
		assertThat(course1.getTutors().size(), is(1));
		assertThat(course1.getStudentGroups().size(), is(3));
		assertThat(course1.getWritingActivities().size(), is(3));
		assertThat(course1.getWritingActivities().size(), is(3));

		Course course2 = assignmentDao.loadCourse(this.course2.getId());
		...
		Course course3 = assignmentDao.loadCourse(this.course3.getId());
